...
namespace MOBOT.BHL.DAL
{
	partial class TitleItemDAL 
	{
		...
		public TitleItem TitleItemInsertAuto(
			...
			short? itemSequence)
		{
			return TitleItemInsertAuto( sqlConnection, sqlTransaction, "BHL", titleID, itemID, itemSequence );
		}
		...
		public TitleItem TitleItemUpdateAuto(
			...
			short? itemSequence)
		{
			return TitleItemUpdateAuto( sqlConnection, sqlTransaction, "BHL", titleItemID, titleID, itemID, itemSequence);
		}
