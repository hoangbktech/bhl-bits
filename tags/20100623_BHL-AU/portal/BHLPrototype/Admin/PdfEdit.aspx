<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PdfEdit.aspx.cs" Inherits="MOBOT.BHL.Web.Admin.PdfEdit" 
    ValidateRequest="false" EnableEventValidation="false" %>
<%@ Register Src="/Admin/Controls/ErrorControl.ascx" TagName="ErrorControl" TagPrefix="mobot" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
	<a href="/Admin/PdfWeeklyStats.aspx">&lt; Return to PDF Generation Weekly Stats</a><br />
	<br />
