<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="TitleImport.aspx.cs" Inherits="MOBOT.BHL.Web.Admin.TitleImport" %>
<%@ Register Src="/Admin/Controls/ErrorControl.ascx" TagName="ErrorControl" TagPrefix="mobot" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <br />
    <a href="/Admin/TitleSearch.aspx">&lt; Go to Title Search/Import</a><br />
    <a href="/Admin/TitleImportHistory.aspx">&lt; View Title Import History</a><br />
    <br />
