...
namespace MOBOT.BHL.Server
{
    public partial class BHLProvider
    {
        ...
        public CustomGenericList<TitleTag> MarcSelectTitleTagsByMarcID(int marcID)
        {
            return new MarcDAL().MarcSelectTitleTagsByMarcID(null, null, marcID);
        }
        ...
        public CustomGenericList<Title_Creator> MarcSelectCreatorsByMarcID(int marcID)
        {
            return new MarcDAL().MarcSelectCreatorsByMarcID(null, null, marcID);
        }

        public CustomGenericList<Title_TitleIdentifier> MarcSelectTitleIdentifiersByMarcID(int marcID)
        {
