...
{	
	...
	public abstract class __Item : CustomObjectBase, ICloneable, IComparable, IDisposable, ISetValues
	{
		...
		public __Item(int itemID, 
			...
			string copyrightEvidenceDate) : this()
		{
			_ItemID = itemID;
		...
		/// DBMS data type: nvarchar(100); Nullable;
		/// </summary>
		[ColumnDefinition("Sponsor", DbTargetType=SqlDbType.NVarChar, Ordinal=9, CharacterMaxLength=100, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("ItemDescription", DbTargetType=SqlDbType.NText, Ordinal=10, CharacterMaxLength=1073741823, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("ScannedBy", DbTargetType=SqlDbType.Int, Ordinal=11, NumericPrecision=10, IsNullable=true)]
		...
		/// DBMS data type: int; Nullable;
		/// </summary>
		[ColumnDefinition("VaultID", DbTargetType=SqlDbType.Int, Ordinal=13, NumericPrecision=10, IsInForeignKey=true, IsNullable=true)]
		public int? VaultID
		{
			get
			{
		...
		/// </summary>
		[ColumnDefinition("NumberOfFiles", DbTargetType=SqlDbType.SmallInt, Ordinal=14, NumericPrecision=5, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("Note", DbTargetType=SqlDbType.NVarChar, Ordinal=15, CharacterMaxLength=255, IsNullable=true)]
		public string Note
		{
			get
			{
		...
		/// </summary>
		[ColumnDefinition("CreationDate", DbTargetType=SqlDbType.DateTime, Ordinal=16, IsNullable=true)]
		...
		/// DBMS data type: datetime; Nullable;
		/// </summary>
		[ColumnDefinition("LastModifiedDate", DbTargetType=SqlDbType.DateTime, Ordinal=17, IsNullable=true)]
		...
		/// DBMS data type: int; Nullable;
		/// </summary>
		[ColumnDefinition("CreationUserID", DbTargetType=SqlDbType.Int, Ordinal=18, NumericPrecision=10, IsNullable=true)]
		...
		/// DBMS data type: int; Nullable;
		/// </summary>
		[ColumnDefinition("LastModifiedUserID", DbTargetType=SqlDbType.Int, Ordinal=19, NumericPrecision=10, IsNullable=true)]
		...
		/// DBMS data type: int;
		/// </summary>
		[ColumnDefinition("ItemStatusID", DbTargetType=SqlDbType.Int, Ordinal=20, NumericPrecision=10, IsInForeignKey=true)]
		...
		/// DBMS data type: int; Nullable;
		/// </summary>
		[ColumnDefinition("PaginationStatusID", DbTargetType=SqlDbType.Int, Ordinal=25, NumericPrecision=10, IsInForeignKey=true, IsNullable=true)]
		...
		/// DBMS data type: int; Nullable;
		/// </summary>
		[ColumnDefinition("ItemSourceID", DbTargetType=SqlDbType.Int, Ordinal=29, NumericPrecision=10, IsInForeignKey=true, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("Year", DbTargetType=SqlDbType.NVarChar, Ordinal=30, CharacterMaxLength=20, IsNullable=true)]
		public string Year
		{
			get
			{
		...
		/// DBMS data type: nvarchar(50); Nullable;
		/// </summary>
		[ColumnDefinition("IdentifierBib", DbTargetType=SqlDbType.NVarChar, Ordinal=31, CharacterMaxLength=50, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("FileRootFolder", DbTargetType=SqlDbType.NVarChar, Ordinal=32, CharacterMaxLength=250, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("ZQuery", DbTargetType=SqlDbType.NVarChar, Ordinal=33, CharacterMaxLength=200, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("LicenseUrl", DbTargetType=SqlDbType.NVarChar, Ordinal=34, CharacterMaxLength=1073741823, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(MAX); Nullable;
		/// </summary>
		[ColumnDefinition("Rights", DbTargetType=SqlDbType.NVarChar, Ordinal=35, CharacterMaxLength=1073741823, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(MAX); Nullable;
		/// </summary>
		[ColumnDefinition("DueDiligence", DbTargetType=SqlDbType.NVarChar, Ordinal=36, CharacterMaxLength=1073741823, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(MAX); Nullable;
		/// </summary>
		[ColumnDefinition("CopyrightStatus", DbTargetType=SqlDbType.NVarChar, Ordinal=37, CharacterMaxLength=1073741823, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(MAX); Nullable;
		/// </summary>
		[ColumnDefinition("CopyrightComment", DbTargetType=SqlDbType.NVarChar, Ordinal=39, CharacterMaxLength=1073741823, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(MAX); Nullable;
		/// </summary>
		[ColumnDefinition("CopyrightEvidence", DbTargetType=SqlDbType.NVarChar, Ordinal=40, CharacterMaxLength=1073741823, IsNullable=true)]
