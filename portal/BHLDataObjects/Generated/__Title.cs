...
{	
	...
	public abstract class __Title : CustomObjectBase, ICloneable, IComparable, IDisposable, ISetValues
	{
		...
		public __Title(int titleID, 
			...
			string currentPublicationFrequency) : this()
		{
			_TitleID = titleID;
			MARCBibID = mARCBibID;
		...
		/// DBMS data type: nvarchar(255); Nullable;
		/// </summary>
		[ColumnDefinition("PartNumber", DbTargetType=SqlDbType.NVarChar, Ordinal=10, CharacterMaxLength=255, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(255); Nullable;
		/// </summary>
		[ColumnDefinition("PartName", DbTargetType=SqlDbType.NVarChar, Ordinal=11, CharacterMaxLength=255, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("CallNumber", DbTargetType=SqlDbType.NVarChar, Ordinal=12, CharacterMaxLength=100, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(255); Nullable;
		/// </summary>
		[ColumnDefinition("PublicationDetails", DbTargetType=SqlDbType.NVarChar, Ordinal=13, CharacterMaxLength=255, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("StartYear", DbTargetType=SqlDbType.SmallInt, Ordinal=14, NumericPrecision=5, IsNullable=true)]
		...
		/// DBMS data type: smallint; Nullable;
		/// </summary>
		[ColumnDefinition("EndYear", DbTargetType=SqlDbType.SmallInt, Ordinal=15, NumericPrecision=5, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("Datafield_260_a", DbTargetType=SqlDbType.NVarChar, Ordinal=16, CharacterMaxLength=150, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(255); Nullable;
		/// </summary>
		[ColumnDefinition("Datafield_260_b", DbTargetType=SqlDbType.NVarChar, Ordinal=17, CharacterMaxLength=255, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(100); Nullable;
		/// </summary>
		[ColumnDefinition("Datafield_260_c", DbTargetType=SqlDbType.NVarChar, Ordinal=18, CharacterMaxLength=100, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("InstitutionCode", DbTargetType=SqlDbType.NVarChar, Ordinal=19, CharacterMaxLength=10, IsInForeignKey=true, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(10); Nullable;
		/// </summary>
		[ColumnDefinition("LanguageCode", DbTargetType=SqlDbType.NVarChar, Ordinal=20, CharacterMaxLength=10, IsInForeignKey=true, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("TitleDescription", DbTargetType=SqlDbType.NText, Ordinal=21, CharacterMaxLength=1073741823, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(100); Nullable;
		/// </summary>
		[ColumnDefinition("TL2Author", DbTargetType=SqlDbType.NVarChar, Ordinal=22, CharacterMaxLength=100, IsNullable=true)]
		...
		/// DBMS data type: bit;
		/// </summary>
		[ColumnDefinition("PublishReady", DbTargetType=SqlDbType.Bit, Ordinal=23)]
		...
		/// DBMS data type: bit;
		/// </summary>
		[ColumnDefinition("RareBooks", DbTargetType=SqlDbType.Bit, Ordinal=24)]
		...
		/// DBMS data type: nvarchar(255); Nullable;
		/// </summary>
		[ColumnDefinition("Note", DbTargetType=SqlDbType.NVarChar, Ordinal=25, CharacterMaxLength=255, IsNullable=true)]
		public string Note
		{
			get
			{
		...
		/// </summary>
		[ColumnDefinition("CreationDate", DbTargetType=SqlDbType.DateTime, Ordinal=26, IsNullable=true)]
		...
		/// DBMS data type: datetime; Nullable;
		/// </summary>
		[ColumnDefinition("LastModifiedDate", DbTargetType=SqlDbType.DateTime, Ordinal=27, IsNullable=true)]
		...
		/// DBMS data type: int; Nullable;
		/// </summary>
		[ColumnDefinition("CreationUserID", DbTargetType=SqlDbType.Int, Ordinal=28, NumericPrecision=10, IsNullable=true)]
		...
		/// DBMS data type: int; Nullable;
		/// </summary>
		[ColumnDefinition("LastModifiedUserID", DbTargetType=SqlDbType.Int, Ordinal=29, NumericPrecision=10, IsInForeignKey=true, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(100); Nullable;
		/// </summary>
		[ColumnDefinition("OriginalCatalogingSource", DbTargetType=SqlDbType.NVarChar, Ordinal=30, CharacterMaxLength=100, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("EditionStatement", DbTargetType=SqlDbType.NVarChar, Ordinal=31, CharacterMaxLength=450, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(100); Nullable;
		/// </summary>
		[ColumnDefinition("CurrentPublicationFrequency", DbTargetType=SqlDbType.NVarChar, Ordinal=32, CharacterMaxLength=100, IsNullable=true)]
