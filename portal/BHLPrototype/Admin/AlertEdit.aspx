<%@ Page Language="C#" MasterPageFile="/Admin/Admin.Master" AutoEventWireup="True" CodeBehind="AlertEdit.aspx.cs" Inherits="MOBOT.BHL.Web.Admin.AlertEdit" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
	...
	<br />	
	<div style="width: 100%"><table width=90%><tr><td>
		<FCKeditorV2:FCKeditor ID="txtAlertMessage" runat="server" BasePath="/Admin/controls/FCKeditor/" />
	</td></tr></table></div>
	<br />
