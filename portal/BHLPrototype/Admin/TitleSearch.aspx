<%@ Page Language="C#" MasterPageFile="/Admin/Admin.Master" AutoEventWireup="true" Codebehind="TitleSearch.aspx.cs" Inherits="MOBOT.BHL.Web.Admin.TitleSearch"
	ValidateRequest="false" %>

<%@ Register Src="/Admin/Controls/PagingUserControl.ascx" TagName="PagingUserControl" TagPrefix="mobot" %>
			...
			<td>
				...
				GridLines="None" OnSorting="gvwResults_Sorting" AllowSorting="true" AlternatingRowStyle-BackColor="#F7FAFB"
					...
					<Columns>
						...
						<asp:HyperLinkField HeaderText="Title" DataNavigateUrlFields="TitleID" DataNavigateUrlFormatString="/Admin/TitleEdit.aspx?id={0}" DataTextField="SortTitle"
							NavigateUrl="/Admin/TitleEdit.aspx" SortExpression="SortTitle" ControlStyle-Width="100%" />
					</Columns>
