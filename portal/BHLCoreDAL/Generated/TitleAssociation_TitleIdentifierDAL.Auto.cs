...
namespace MOBOT.BHL.DAL
{
	partial class TitleAssociation_TitleIdentifierDAL 
	{
		...
		{
			return TitleAssociation_TitleIdentifierInsertAuto( sqlConnection, sqlTransaction, "BHL", titleAssociationID, titleIdentifierID, identifierValue );
		}
		...
		public TitleAssociation_TitleIdentifier TitleAssociation_TitleIdentifierUpdateAuto(
			...
			string identifierValue)
		{
			return TitleAssociation_TitleIdentifierUpdateAuto( sqlConnection, sqlTransaction, "BHL", titleAssociation_TitleIdentifierID, titleAssociationID, titleIdentifierID, identifierValue);
		}
