...
namespace MOBOT.BHL.DAL
{
	partial class TitleAssociationDAL 
	{
		...
		{
			return TitleAssociationInsertAuto( sqlConnection, sqlTransaction, "BHL", titleID, titleAssociationTypeID, title, section, volume, heading, publication, relationship, active, associatedTitleID );
		}
		...
		public TitleAssociation TitleAssociationUpdateAuto(
			...
			int? associatedTitleID)
		{
			return TitleAssociationUpdateAuto( sqlConnection, sqlTransaction, "BHL", titleAssociationID, titleID, titleAssociationTypeID, title, section, volume, heading, publication, relationship, active, associatedTitleID);
		}
