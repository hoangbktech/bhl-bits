...
namespace MOBOT.BHL.DAL
{
	partial class TitleLanguageDAL 
	{
		...
		public TitleLanguage TitleLanguageInsertAuto(
			...
			string languageCode)
		{
			return TitleLanguageInsertAuto( sqlConnection, sqlTransaction, "BHL", titleID, languageCode );
		}
		...
		public CustomDataAccessStatus<TitleLanguage> TitleLanguageManageAuto(
			...
			TitleLanguage value  )
		{
			return TitleLanguageManageAuto( sqlConnection, sqlTransaction, "BHL", value  );
		}
