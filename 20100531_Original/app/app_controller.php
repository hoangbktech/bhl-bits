...
class AppController extends controller
  {
	...
	// Authorisation - stick any view/controller that requires a login to access in the following array
	  var $othAuthRestrictions = array('Add','edit','delete','bidall','bidpartial','pages/admin','dedup','dedupselect0','batch','edit','addtitle','digitizedtitles/edit','digitizedtitles/add', 'iprtitles/edit','iprtitles/add');
