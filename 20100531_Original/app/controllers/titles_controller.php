        ...
        function edit($id = null) {
		 ...
		 function pickupatitle($id = null) {
		   ...
		   // this is to try and pull up a record by catkey from titles to be scanned page or tell the user if there is not one that matches.
            ...
            // d) have either
            //       iprtitles.cdm_checked_decision != Rejected (int 1) & titles.any_pre_1860 = Y (int 1) OR
            //       iprtitles.cdm_checked_decision = Accepted (int 2) OR pre-1860 (int 4) & titles.any_pre_1860 = N (int 2)
