  ...
  var $name = 'Problemlistlines';
    ...
    var $uses = array('Problemlistline','Bid','Problemlistline','Status','Title');
     ...
     function add($id = null) {
        ...
        $this->set('Problemstatuses', array(1=>'N/K',2=>'Uncut pages',3=>'Too big',4=>'Too small',5=>'On loan',6=>'Foldouts'));
        ...
        if ($id) {
		   ...
		   $thechronstartdate = $problemlistdata['Problemlist']['chronology_start'];
		   $this->set('thechronstartdatevalue', $thechronstartdate );
		   $thechronenddate = $problemlistdata['Problemlist']['chronology_end'];
		   $this->set('thechronenddatevalue', $thechronenddate );
		   $theenumstartdate = $problemlistdata['Problemlist']['enum_start'];
		   $this->set('theenumstartdatevalue', $theenumstartdate );
		   $theenumenddate = $problemlistdata['Problemlist']['enum_end'];
		   $this->set('theenumenddatevalue', $theenumenddate );
		   $theseries = $problemlistdata['Problemlist']['series'];
		   $this->set('theseriesvalue', $theseries );
		   $thelinestatus = $problemlistdata['Problemlist']['line_status'];
		   $this->set('thelinestatusvalue', $thelinestatus );
		   $theiarejectreason = $problemlistdata['Problemlist']['ia_reject_reason'];
		...
		$numberproblemlistlines = $this->Problemlistline->findCount('`problemlist_id` = ' . $theproblemlistid);
		$this->set('numberproblemlistlinesvalue', ($numberproblemlistlines + 1));
        ...
        if (!empty($this->data['Problemlistline']))
        {
            ...
            if ($this->Problemlistline->save($this->data['Problemlistline'])) {
                ...
                $thechronstartdate = $this->data['Problemlistline']['chronology_start'];
                $this->set('thechronstartdatevalue', $thechronstartdate );
                $thechronenddate = $this->data['Problemlistline']['chronology_end'];
                $this->set('thechronenddatevalue', $thechronenddate );
                $theenumstartdate = $this->data['Problemlistline']['enum_start'];
                $this->set('theenumstartdatevalue', $theenumstartdate );
                $theenumenddate = $this->data['Problemlistline']['enum_end'];
                $this->set('theenumenddatevalue', $theenumenddate );
                $theseries = $this->data['Problemlist']['series'];
                $this->set('theseriesvalue', $theseries );
                $thelinestatus = $this->data['Problemlist']['line_status'];
                $this->set('thelinestatusvalue', $thelinestatus );
                $theiarejectreason = $this->data['Problemlist']['ia_reject_reason'];
                $this->set('theiarejectreasonvalue', $theiarejectreason );

                $thetitleid = $this->data['Problemlistline']['title_id'];
                $this->set('thetitleidvalue', $thetitleid );
                ...
                // set an incremented line number too.
                $thelinenumber = $this->data['Problemlistline']['linenumber'];
                $this->set('thelinenumbervalue', ($thelinenumber + 1));
