<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="TitleAssociationEdit.aspx.cs" Inherits="MOBOT.BHL.Web.Admin.TitleAssociationEdit" %>
...
<body>
		...
		<table cellpadding="4" width="100%">
			...
			<tr>
				...
				<td valign="top" colspan="2">
				    ...
				    <span style="font-size:10px;text-decoration:underline;color:#a54219;" onclick="overlay();document.getElementById('srchTitleID').focus();">Update</span>&nbsp;&nbsp;
			...
			AlternatingRowStyle-BackColor="#F7FAFB" RowStyle-BackColor="white"
				...
				<Columns>
					...
					<asp:TemplateField HeaderText="Identifier" ItemStyle-Width="250px">
						...
						<EditItemTemplate>
							<asp:DropDownList ID="ddlIdentifierName" runat="server" DataTextField="IdentifierName" DataValueField="TitleIdentifierID" 
							    DataSource="<%# GetTitleIdentifiers() %>" SelectedIndex="<%# GetTitleIdentifierIndex( Container.DataItem ) %>" Width="250px" />
						</EditItemTemplate>
					</asp:TemplateField>
	...
	<div id="overlay" style="background-image:url(/admin/images/blank.gif);">
