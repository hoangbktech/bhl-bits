...
{	
	...
	public abstract class __TitleAssociation : CustomObjectBase, ICloneable, IComparable, IDisposable, ISetValues
	{
		...
		/// DBMS data type: nvarchar(500);
		/// </summary>
		[ColumnDefinition("Heading", DbTargetType=SqlDbType.NVarChar, Ordinal=7, CharacterMaxLength=500)]
		...
		/// DBMS data type: nvarchar(500);
		/// </summary>
		[ColumnDefinition("Publication", DbTargetType=SqlDbType.NVarChar, Ordinal=8, CharacterMaxLength=500)]
		...
		/// DBMS data type: nvarchar(500);
		/// </summary>
		[ColumnDefinition("Relationship", DbTargetType=SqlDbType.NVarChar, Ordinal=9, CharacterMaxLength=500)]
		...
		/// </summary>
		[ColumnDefinition("AssociatedTitleID", DbTargetType=SqlDbType.Int, Ordinal=11, NumericPrecision=10, IsInForeignKey=true, IsNullable=true)]
