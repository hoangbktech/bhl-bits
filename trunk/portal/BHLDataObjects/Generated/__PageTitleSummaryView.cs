...
// Generated 5/19/2009 2:55:16 PM
// Do not modify the contents of this code file.
// This abstract class __PageTitleSummaryView is based upon PageTitleSummaryView.
...
// {
//		[Serializable]
// 		public class PageTitleSummaryView : __PageTitleSummaryView
//		{
//		}
// }
...
{	
	[Serializable]
	public abstract class __PageTitleSummaryView : CustomObjectBase, ICloneable, IComparable, IDisposable, ISetValues
	{
		#region Constructors
		...
		public __PageTitleSummaryView(string mARCBibID, 
			int titleID, 
			string fullTitle, 
			bool rareBooks, 
			string shortTitle, 
		...
		/// </summary>
		[ColumnDefinition("FullTitle", DbTargetType=SqlDbType.NVarChar, Ordinal=3, CharacterMaxLength=2000)]
		...
		/// </summary>
		[ColumnDefinition("ShortTitle", DbTargetType=SqlDbType.NVarChar, Ordinal=5, CharacterMaxLength=255, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("SortTitle", DbTargetType=SqlDbType.NVarChar, Ordinal=6, CharacterMaxLength=60, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(255); Nullable;
		/// </summary>
		[ColumnDefinition("PartNumber", DbTargetType=SqlDbType.NVarChar, Ordinal=7, CharacterMaxLength=255, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(255); Nullable;
		/// </summary>
		[ColumnDefinition("PartName", DbTargetType=SqlDbType.NVarChar, Ordinal=8, CharacterMaxLength=255, IsNullable=true)]
		...
		/// DBMS data type: int;
		/// </summary>
		[ColumnDefinition("ItemStatusID", DbTargetType=SqlDbType.Int, Ordinal=9, NumericPrecision=10)]
		...
		/// DBMS data type: int;
		/// </summary>
		[ColumnDefinition("ItemID", DbTargetType=SqlDbType.Int, Ordinal=10, NumericPrecision=10)]
		public int ItemID
		{
			get
			{
		...
		/// </summary>
		[ColumnDefinition("BarCode", DbTargetType=SqlDbType.NVarChar, Ordinal=11, CharacterMaxLength=40)]
		...
		/// </summary>
		[ColumnDefinition("PDFSize", DbTargetType=SqlDbType.Int, Ordinal=12, NumericPrecision=10, IsNullable=true)]
		public int? PDFSize
		{
			get
			{
		...
		/// </summary>
		[ColumnDefinition("Volume", DbTargetType=SqlDbType.NVarChar, Ordinal=13, CharacterMaxLength=100, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("FileRootFolder", DbTargetType=SqlDbType.NVarChar, Ordinal=14, CharacterMaxLength=250, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("ItemSequence", DbTargetType=SqlDbType.SmallInt, Ordinal=15, NumericPrecision=5, IsNullable=true)]
		...
		/// DBMS data type: int;
		/// </summary>
		[ColumnDefinition("PageID", DbTargetType=SqlDbType.Int, Ordinal=16, NumericPrecision=10)]
		public int PageID
		{
			get
			{
		...
		/// DBMS data type: nvarchar(50);
		/// </summary>
		[ColumnDefinition("FileNamePrefix", DbTargetType=SqlDbType.NVarChar, Ordinal=17, CharacterMaxLength=50)]
		...
		/// DBMS data type: nvarchar(255); Nullable;
		/// </summary>
		[ColumnDefinition("PageDescription", DbTargetType=SqlDbType.NVarChar, Ordinal=18, CharacterMaxLength=255, IsNullable=true)]
		...
		/// DBMS data type: int; Nullable;
		/// </summary>
		[ColumnDefinition("SequenceOrder", DbTargetType=SqlDbType.Int, Ordinal=19, NumericPrecision=10, IsNullable=true)]
		...
		/// DBMS data type: bit;
		/// </summary>
		[ColumnDefinition("Illustration", DbTargetType=SqlDbType.Bit, Ordinal=20)]
		...
		/// DBMS data type: bit;
		/// </summary>
		[ColumnDefinition("Active", DbTargetType=SqlDbType.Bit, Ordinal=21)]
		public bool Active
		{
			get
			{
		...
		/// </summary>
		[ColumnDefinition("ExternalURL", DbTargetType=SqlDbType.NVarChar, Ordinal=22, CharacterMaxLength=500, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(500); Nullable;
		/// </summary>
		[ColumnDefinition("AltExternalURL", DbTargetType=SqlDbType.NVarChar, Ordinal=23, CharacterMaxLength=500, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("WebVirtualDirectory", DbTargetType=SqlDbType.NVarChar, Ordinal=24, CharacterMaxLength=30, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(100); Nullable;
		/// </summary>
		[ColumnDefinition("OCRFolderShare", DbTargetType=SqlDbType.NVarChar, Ordinal=25, CharacterMaxLength=100, IsNullable=true)]
		...
		/// </summary>
		[ColumnDefinition("DownloadUrl", DbTargetType=SqlDbType.NVarChar, Ordinal=26, CharacterMaxLength=100)]
		...
		/// </summary>
		[ColumnDefinition("ImageServerUrlFormat", DbTargetType=SqlDbType.NVarChar, Ordinal=27, CharacterMaxLength=200)]
		...
		/// <summary>
		/// Deserializes the byte array and returns an instance of <see cref="__PageTitleSummaryView"/>.
		/// </summary>
		/// <returns>If the byte array can be deserialized and cast to an instance of <see cref="__PageTitleSummaryView"/>, 
		/// returns an instance of <see cref="__PageTitleSummaryView"/>; otherwise returns null.</returns>
		public static new __PageTitleSummaryView FromArray(byte[] byteArray)
		{
			__PageTitleSummaryView o = null;
			
			try
			{
				o = (__PageTitleSummaryView) CustomObjectBase.FromArray(byteArray);
			}
			catch (Exception e)
			{
				throw e;
		...
		/// <summary>
		/// Compares this instance with a specified object. Throws an ArgumentException if the specified object is not of type <see cref="__PageTitleSummaryView"/>.
		/// </summary>
		/// <param name="obj">An <see cref="__PageTitleSummaryView"/> object to compare with this instance.</param>
		/// <returns>0 if the specified object equals this instance; -1 if the specified object does not equal this instance.</returns>
		public virtual int CompareTo(Object obj)
		{
			if (obj is __PageTitleSummaryView)
			{
				__PageTitleSummaryView o = (__PageTitleSummaryView) obj;
			...
			{
				throw new ArgumentException("Argument is not of type __PageTitleSummaryView");
			}
		}
		...
		/// </summary>
		/// <param name="a">The first <see cref="__PageTitleSummaryView"/> object to compare.</param>
		/// <param name="b">The second <see cref="__PageTitleSummaryView"/> object to compare.</param>
		/// <returns>true if values of operands are equal, false otherwise.</returns>
		public static bool operator == (__PageTitleSummaryView a, __PageTitleSummaryView b)
		{
		...
		/// </summary>
		/// <param name="obj">The <see cref="__PageTitleSummaryView"/> object to compare with the current <see cref="__PageTitleSummaryView"/>.</param>
		...
		public override bool Equals(Object obj)
		{
			...
			return this == (__PageTitleSummaryView) obj;
		}
		...
		/// list.Sort(SortOrder.Ascending, __PageTitleSummaryView.SortColumn.MARCBibID);
		/// </summary>
		[Serializable]
