...
{	
	...
	public abstract class __IndicatedPage : CustomObjectBase, ICloneable, IComparable, IDisposable, ISetValues
	{
		...
		/// Description: A number to separately identify various series of Indicated Pages.
		/// </summary>
		[ColumnDefinition("Sequence", DbTargetType=SqlDbType.SmallInt, Ordinal=2, Description="A number to separately identify various series of Indicated Pages.", NumericPrecision=5, IsInPrimaryKey=true)]
		...
		/// Description: Prefix portion of Indicated Page.
		/// </summary>
		[ColumnDefinition("PagePrefix", DbTargetType=SqlDbType.NVarChar, Ordinal=3, Description="Prefix portion of Indicated Page.", CharacterMaxLength=20, IsNullable=true)]
		...
		/// Column: PageNumber;
		/// DBMS data type: nvarchar(20); Nullable;
		/// Description: Page Number portion of Indicated Page.
		/// </summary>
		[ColumnDefinition("PageNumber", DbTargetType=SqlDbType.NVarChar, Ordinal=4, Description="Page Number portion of Indicated Page.", CharacterMaxLength=20, IsNullable=true)]
