<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Stats.aspx.cs" Inherits="MOBOT.BHL.Web.Admin.Stats"%>
...
<br />
	...
	<table cellpadding="7" cellspacing="7"><tr><td valign="top">
        ...
        <div style="overflow:auto;height:225px;width:425px;border-style:solid;border-color:Black;border-width:1px">
        ...
        <div class="tableHeader">Refine Statistics</div><br />
        Institution:
